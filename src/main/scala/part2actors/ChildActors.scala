...
object ChildActors extends App {
  ...
  /**
   * Danger. CLOSING OVER SCENARIO
   *
   * NEVER PASS MUTABLE ACTOR STATE, OR THE `THIS` PREFERENCE, TO CHILD ACTORS
   * The whole actor system could be broken
   *
  ...
  class NaiveBankAccount extends Actor {
    ...
    def withdraw(funds: Int) = {
      println(s"[${self.path}] withdrawing funds $funds from of $amount")
      amount -= funds
    }
  }
